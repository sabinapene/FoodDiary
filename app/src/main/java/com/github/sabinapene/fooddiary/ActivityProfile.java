...
public class ActivityProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.changeBMITextView).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( ActivityProfile.this, ActivityChangeBMI.class));
            }
        });
        ...
        findViewById(R.id.signOutBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityProfile.this, ActivitySignIn.class));
                firebaseAuth.signOut();
                ActivitySignIn.resetCurrentUserEmail();
            }
